...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updatePreview1() {
            ...
            const previewUrl1 = `<?php echo e(url('/pertemuan1/param')); ?>/${param1}`;
        ...
        function updatePreview2() {
            ...
            const previewUrl2 = `<?php echo e(url('/pertemuan1/param')); ?>/${param1}/${param2}`;
        ...
        form1.addEventListener('submit', function(e) {
            e.preventDefault();
            const param1 = encodeURIComponent(param1Input.value);
            const url = `<?php echo e(url('/pertemuan1/param')); ?>/${param1}`;
        ...
        form2.addEventListener('submit', function(e) {
            ...
            const param1 = encodeURIComponent(param1Input2.value);
            const param2 = encodeURIComponent(param2Input2.value);
            const url = `<?php echo e(url('/pertemuan1/param')); ?>/${param1}/${param2}`;
            window.location.href = url;
        });
...
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\UNI\SEM 5\PBKK\tugas_1\resources\views/pertemuan1/param.blade.php ENDPATH**/ ?>