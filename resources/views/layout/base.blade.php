        ...
        <aside class="main-sidebar sidebar-blue-primary elevation-4">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex align-items-center">
                    ...
                    <div class="info ml-2">
                        <a href="#" class="d-block">
                            {{ session('user_name','Almira Raisa Izzatina') }}
                            <br>
          ...
          <li data-pertemuan="1" class="nav-item has-treeview {{ request()->is('pertemuan1/*') ? 'menu-open' : '' }} ">
            ...
            <ul class="nav nav-treeview">
                <!-- basic routing -->
                <li class="nav-item">
                    <a href="pertemuan1/basicrouting" class="nav-link {{ request()->is('pertemuan1/basicrouting') ? 'active' : '' }}">
                ...
                <!-- route parameters -->
                <li class="nav-item">
                    <a href="{{ route('param') }}" class="nav-link {{ request()->routeIs('param') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 10px;"></i>
                ...
                <!-- named routing -->
                <li class="nav-item">
                    <a href="{{ route('named') }}" class="nav-link {{ request()->routeIs('named') ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon" style="font-size: 10px;"></i>
                            <p>Named Routing</p>
                    </a>
                </li>  
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('route1') }}" class="nav-link {{ request()->routeIs('route1') ? 'active' : '' }}">
                                <i class="nav-icon fas fa-circle" style="font-size: 10px;"></i>
                                <p style="margin-left: 15px;">Route 1</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('route2') }}" class="nav-link {{ request()->routeIs('route2') ? 'active' : '' }}">
                                <i class="nav-icon fas fa-circle" style="font-size: 10px;"></i>
                ...
                <!-- fallback routing -->
                <li class="nav-item">
                    <a href="{{ route('error') }}" class="nav-link {{ request()->routeIs('error') ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon" style="font-size: 10px;"></i>
                ...
                <!-- <li class="nav-item">
                  <a href="/adminlte/" class="nav-link"  target="_blank">
                      ...
                      <p>Template AdminLTE</p>
                        ...
                        <!-- <li data-pertemuan="2"
                            class="nav-item has-treeview  {{ request()->is('pertemuan2/*') ? 'menu-open' : '' }} ">
                        ...
                        <li data-pertemuan="3" class="nav-item has-treeview">
                            <a href="#" class="nav-link {{ request()->is('pertemuan3/*') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('pertemuan3.index') }}"
                                        class="nav-link {{ request()->routeIs('') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon" style="font-size: 10px;"></i>\
                                        <p>Autentikasi & Otorisasi</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
